...
func calculatePercentageAndGrades(student Student) (float64, rune) {
	...
	*/
	...
	switch percentage = (student.courses.algorithm + student.courses.calculus + student.courses.dataLogic) / 3; {
	case percentage > 90.0:
		grade = 'A'
	case percentage < 90.0 && grade >= 80.0:
		grade = 'B'
	case percentage < 80.0 && percentage >= 70.0:
		grade = 'C'
